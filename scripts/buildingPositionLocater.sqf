...
while {true} do{
	...
	if (_nearestBuilding distance _screenPosition <10) then{
		...
		if (_positionCount >0) then{
			...
			hintSilent parseText format["<t size='1.25' font='puristaMedium' color='#ffff00' align ='left'>Selected Building :<br/></t> 
				<t size='1.25' font='puristaMedium' color='#FFFFFF' align ='left'>%1<br/></t>
				<t size='1.25' font='puristaMedium' color='#ffff00' align ='left'>Number Of Positions :</t>
				<t size='1.25' font='puristaMedium' color='#FFFFFF' align ='left'> %2<br/><br/></t>
				<t size='0.9' font='puristaMedium' color='#ffff00' align ='left'>View Building Positions (END).</t>", typeOf _nearestBuilding, _positionCount];
			...
			if (showPositions) then{
				...
				waitUntil {
					hintSilent parseText format["<t size='1.25' font='puristaMedium' color='#ffff00' align ='left'>Selected Building :<br/></t> 
						<t size='1.25' font='puristaMedium' color='#FFFFFF' align ='left'>%1<br/></t>
						<t size='1.25' font='puristaMedium' color='#ffff00' align ='left'>Number Of Positions :</t><t size='1.25' font='puristaMedium' color='#FFFFFF' align ='left'> %2</t><br/>
						<t size='1.25' font='puristaMedium' color='#ffff00' align ='left'>Current Position :<br/><br/></t>
						<t size='0.9' font='puristaMedium' color='#ffff00' align ='left'>Return To Building Selection (END).</t>", typeOf _nearestBuilding, _positionCount];
					...
					if (player distance _nearestMkr <= 1.5) then{
						...
						while {True} do{
							hintSilent parseText format["<t size='1.25' font='puristaMedium' color='#ffff00' align ='left'>Selected Building :<br/></t> 
								<t size='1.25' font='puristaMedium' color='#FFFFFF' align ='left'>%1<br/></t>
								<t size='1.25' font='puristaMedium' color='#ffff00' align ='left'>Number Of Positions :</t><t size='1.25' font='puristaMedium' color='#FFFFFF' align ='left'> %2</t><br/>
								<t size='1.25' font='puristaMedium' color='#ffff00' align ='left'>Current Position :</t><t size='1.25' font='puristaMedium' color='#FFFFFF' align ='left'> %3</t><br/><br/>
								<t size='0.9' font='puristaMedium' color='#ffff00' align ='left'>Return To Building Selection (END).</t>
								<t size='0.9' font='puristaMedium' color='#ffff00' align ='left'>Copy Position To Clipboard (INSERT).</t>", typeOf _nearestBuilding, _positionCount, pos];							
